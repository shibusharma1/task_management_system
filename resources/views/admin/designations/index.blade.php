    ...
    <div class="mb-6 flex justify-between items-center flex-wrap">
        ...
        <div class="flex space-x-2">
            <form method="GET" class="flex space-x-2">
                <input type="text" name="search" value="{{ $search }}" placeholder="Search designations..."
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-4 py-2">{{ $designations->firstItem() + $index }}</td>
                        <td class="px-4 py-2 font-semibold text-gray-800">{{ $designation->designation_name }}</td>
                        <td class="px-4 py-2 text-gray-600">{{ $designation->hierarchy_level }}</td>
...
<script>
    ...
    document.querySelectorAll('.edit-btn').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            form.action = `/admin/designations/${btn.dataset.id}`;
