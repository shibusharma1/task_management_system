        ...
        <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    <div class="relative">
                        <select
                            class="appearance-none bg-white border border-gray-300 rounded-md pl-3 pr-8 py-1 text-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                @if($user->hierarchy_level == 0) bg-indigo-100 text-indigo-800 
                                                @elseif($user->hierarchy_level == 1) bg-green-100 text-green-800 
                                                @elseif($user->hierarchy_level == 2) bg-yellow-100 text-yellow-800 
                                                @else bg-gray-100 text-gray-800 @endif">

                                            @if($user->hierarchy_level == 0)
                                            Administrator
                                            @elseif($user->hierarchy_level == 1)
                                            Manager
                                            @elseif($user->hierarchy_level == 2)
                                            Employee
                                            @else
                                            User
                                            @endif
